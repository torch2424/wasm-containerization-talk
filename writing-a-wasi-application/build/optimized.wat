(module
 ...
 (data (i32.const 64) "\0c\00\00\00\01\00\00\00\01\00\00\00\0c\00\00\00A\00b\00o\00r\00t\00!")
 (data (i32.const 96) "\02\00\00\00\01\00\00\00\01\00\00\00\02\00\00\00\n")
 (data (i32.const 128) "\08\00\00\00\01\00\00\00\01\00\00\00\08\00\00\00n\00u\00l\00l")
 ...
 (data (i32.const 336) "\1e\00\00\00\01\00\00\00\01\00\00\00\1e\00\00\00~\00l\00i\00b\00/\00r\00t\00/\00t\00l\00s\00f\00.\00t\00s")
 ...
 (data (i32.const 448) "\16\00\00\00\01\00\00\00\01\00\00\00\16\00\00\00H\00e\00l\00l\00o\00 \00W\00A\00S\00I\00!")
 (data (i32.const 496) "\03\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10")
 ...
 (export "wasi_abort" (func $assembly/index/wasi_abort|trampoline))
 (func $~lib/rt/pure/increment (; 2 ;) (param $0 i32)
  (local $1 i32)
  local.get $0
  i32.load offset=4
  local.tee $1
  ...
  i32.ne
  if
   call $assembly/index/wasi_abort
   unreachable
  end
  local.get $0
  local.get $1
 ...
 (func $~lib/rt/pure/__retain (; 3 ;) (param $0 i32) (result i32)
  local.get $0
  i32.const 524
  i32.gt_u
  if
 ...
 (func $~lib/rt/pure/__release (; 4 ;) (param $0 i32)
  local.get $0
  i32.const 524
  i32.gt_u
  if
 ...
 (func $~lib/string/String#concat (; 7 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/string/String.UTF8.byteLength (; 8 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
 ...
 (func $~lib/string/String.UTF8.encode (; 9 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $~lib/memory/memory.fill (; 10 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
 ...
 (func $~lib/arraybuffer/ArrayBuffer#constructor (; 11 ;) (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
 ...
 (func $assembly/index/log (; 12 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/index/wasi_abort (; 13 ;)
  i32.const 80
 ...
 (func $~lib/rt/tlsf/addMemory (; 16 ;) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  local.get $2
  i32.const 15
 ...
 (func $assembly/index/wasi_abort|trampoline (; 28 ;) (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  block $4of4
   block $3of4
    block $2of4
     block $1of4
